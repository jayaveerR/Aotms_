...
const testimonials: (Testimonial & { rating: number })[] = [
    ...
    { text: "The hands-on projects and mock interviews gave me the confidence to face tough technical rounds. Their curriculum is perfectly aligned with what the industry needs.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop", name: "Bilal Ahmed", role: "Cloud Engineer", rating: 4 },
    { text: "Transitioning to Data Science felt daunting, but the mentors here made it seamless. The lifetime career support ensures I always have a roadmap for my growth.", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop", name: "Saman Malik", role: "Data Scientist", rating: 3 },
    ...
    { text: "The resume building sessions were a game-changer. My profile started getting picked up by top tech firms almost immediately after the overhaul.", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop", name: "Zainab Hussain", role: "UI/UX Designer", rating: 4 },
    ...
    { text: "Real-world projects are at the heart of their training. I built a full-scale enterprise app that became the star highlight of my portfolio.", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop", name: "Farhan Siddiqui", role: "Software Architect", rating: 3 },
