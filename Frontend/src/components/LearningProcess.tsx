    ...
    <section className="py-8 md:py-12 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-8 md:mb-10">
          ...
          <h2 className="text-2xl md:text-4xl font-black text-foreground font-display tracking-tight">
            How Training <span className="text-primary">Works</span> <span className="text-accent">Here</span>
          </h2>

          <p className="text-sm md:text-base text-muted-foreground mt-3 font-semibold">
            Join today and follow this <span className="text-accent font-bold">structured path</span> to your IT career
          </p>
        </div>
        ...
        <div className="text-center mt-8 md:mt-12">
          ...
          <div className="mt-6 md:mt-8 text-center">
            <button className="btn-secondary group inline-flex items-center bg-orange-500 text-white text-xs px-8 py-2.5">
