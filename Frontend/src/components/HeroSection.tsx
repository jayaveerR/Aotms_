      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              <span className="block text-xl sm:text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight">
                Become <span className="text-primary">Job-Ready</span> in <span className="text-accent">90 Days</span>
              </span>
              <span className="block text-md sm:text-xl md:text-2xl lg:text-3xl text-muted-foreground mt-2 font-medium">
                Comprehensive IT Training in <span className="text-primary">Vijayawada</span>
              </span>
            </h1>
